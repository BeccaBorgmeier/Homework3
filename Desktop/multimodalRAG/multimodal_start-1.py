...
collection.add(
    ids=["0", "1", "2", "3"],
    uris=["./images/airhockey.jpg", "./images/airhockey1.jpg", "./images/skating.jpg", "./images/beam.jpg"],
    metadatas=[{"category": "sport"}, {"category": "sport"}, {"category": "sport"}, {"category": "sport"}],  # metadata - optional
)
